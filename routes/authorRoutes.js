 ...
 *     tags: [Authors]
 *     description: Retrieve a list of all authors (Public access)
 *     responses:
 *       200:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', ensureAuth, authorValidationRules(), createAuthor);
 ...
 *     tags: [Authors]
 *     description: Retrieve details of a specific author and their books (Public access)
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *     tags: [Authors]
 *     description: Update an existing author's information (Requires authentication)
 *     security:
 *       - cookieAuth: []
 *     parameters:
 *       - in: path
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:id', ensureAuth, authorUpdateValidationRules(), updateAuthor);
 ...
 *     tags: [Authors]
 *     description: Remove an author from the database (Requires admin authentication - only if they have no books)
 *     security:
 *       - cookieAuth: []
 *     parameters:
 *       - in: path
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', ensureAdmin, deleteAuthor);
