 ...
 *     tags: [Books]
 *     description: Retrieve a list of all books in the library (Public access)
 *     responses:
 *       200:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', ensureAuth, bookValidationRules(), createBook);
 ...
 *     tags: [Books]
 *     description: Retrieve details of a specific book by ID (Public access)
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:id', ensureAuth, bookUpdateValidationRules(), updateBook);
 ...
 *     tags: [Books]
 *     description: Remove a book from the library (Requires admin authentication)
 *     security:
 *       - cookieAuth: []
 *     parameters:
 *       - in: path
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', ensureAdmin, deleteBook);
